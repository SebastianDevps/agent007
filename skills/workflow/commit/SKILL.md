---
name: commit
description: "Generate pipe-delimited commits following the team standard: Tipo|IdTarea|YYYYMMDD|Descripción"
invokable: true
version: 2.0.0
---
...
feat|LIQUI|20260320|Implement complete CRUD for cargos module
EOF
)"
```
