...
description: "Deep architecture review: DRY violations, testing gaps, edge cases, performance. Use when user asks to 'review architecture', 'deep code review', 'audit code quality', or 'analyze performance'."
invokable: true
accepts_args: scope
