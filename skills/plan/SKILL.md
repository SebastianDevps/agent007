...
**Por qué**: Cada subagente en `subagent-driven-development` recibe `.sdlc/tasks/n.md` como contexto global. Sin él, los subagentes toman decisiones localmente correctas pero globalmente incompatibles (ej: dos subagentes eligiendo schemas de datos distintos para el mismo recurso). Con el plan compartido, todos trabajan desde el mismo mapa.
