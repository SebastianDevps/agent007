#!/usr/bin/env python3
# CONTRACT EXCEPTION (v7-F1): mutates verified artifact (transformer sensor) — target: SP-2 transformers
"""
...
# Profile awareness: skip in minimal mode (reduces latency during rapid dev cycles)
