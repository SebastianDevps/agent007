...
```
/dev
 ├── /brainstorming          (complex tasks, unclear requirements)
 ├── /using-git-worktrees    (medium + complex: isolated branch)
 ├── /writing-plans          (medium + complex: task breakdown)
